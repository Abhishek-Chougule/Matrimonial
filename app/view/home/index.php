   ...
   <section id="center">
            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item">
                        <img src="asset/b3.jpg" alt="First slide">
                        <div class="carousel-caption">                        </div>
                    </div>
                    <div class="item">
                        <img src="asset/b4.jpg" alt="Second slide">
                        <div class="carousel-caption">                        </div>
                    </div>
                    <div class="item active">
                        <img src="asset/b2.jpg" alt="Third slide">
                        <div class="carousel-caption">                        </div>
                    </div>
                </div>
            </div>
            <div class="main-text hidden-xs clearfix">
                <div class="col-md-12 text-center">
				  <h1>Spruha Marriage Beuro</h1>
				  <p>ईथे जुळती पवित्र नाती . . .</p>
                </div>
            </div>
 </section>
...
<table width="60%" align="center" cellspacing="0" cellpadding="5" border="0"  id="down">
    <!-- <tr>
    ...
    <tr>
        <td>
          <fieldset>
				<legend><b>Find Your Perfect Match</b></legend>
				<form method="POST">
