   ...
   <div class="top clearfix">
	...
	<div class="col-sm-6">
	  <div class="top_right clearfix text-right">
		  ...
		  <span class="span_2"> <i class="fa fa-whatsapp"></i>  <a href="https://api.whatsapp.com/send/?phone=918149004090&text=Hi&type=phone_number&app_absent=0" style="a:link {
color:black;
  text-decoration: none;
}">+91 - 8149004090 </a></span>
	  </div>
	</div>
   </div>
  </div>
